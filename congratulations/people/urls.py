...
urlpatterns = [
    ...
    path('text/<int:pk>/', DetailCongratulationView.as_view(),
         name='text_detail'),
    path('update-text/<int:pk>/', UpdateCongratulationView.as_view(),
         name='text_update'),
    path('delete-text/<int:pk>/', DeleteCongratulationView.as_view(),
         name='text_delete'),
    path('add-people/', CreatePeopleView.as_view(), name='add_people'),
    path('people-update/<int:pk>/', UpdatePeopleView.as_view(),
         name='people_update'),
    path('people-delete/<int:pk>/', DeletePeopleView.as_view(),
         name='people_delete'),
